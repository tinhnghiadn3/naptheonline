...
@Component({
  selector: 'app-news-technology',
  templateUrl: './news-technology.component.html',
  styleUrls: ['./news-technology.component.scss']
})
export class NewsTechnologyComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    this.title = NEW_TYPES.find(_ => _.value === 3).text;
  }
